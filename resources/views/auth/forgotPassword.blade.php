                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" aria-describedby="email" placeholder=" " value="{{ old('email') }}" autofocus required>
                                 @error('email')
