    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <h4 class="card-title">Date Cluster</h4>
                </div>
            </div>
            <div class="card-body px-4">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$detailSite->site_name}}" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label">Alamat Site</label>
                        <input type="text" class="form-control" value="{{$detailSite->site_address}}" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body px-0">
                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        <?php $no = 1;?>
                        @foreach ($daftarSiteDetail as $item)
                            @if ($detailSite->id_site === $item->id_site)
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{{$item->fullname}}</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="/tambah-detail-site/{{$detailSite->id_site}}" method="POST">
                        @csrf
...
<div class="modal fade" id="hapus{{$item->id_site_detail}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin akan hapus <strong>{{$item->fullname}}</strong> dari site ini?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Kembali</button>
