        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form === 'Tambah') /tambah-klien @elseif($form === 'Edit') /edit-klien/{{$detail->id_user}} @endif" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    @include('components.tombolForm', ['linkKembali' => '/daftar-klien'])
                    </form>
                </div>
            </div>
        </div>
