    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body px-4" style="margin-bottom: -50px;">
                <div class="row">
                    <div class="col-lg-12">
                        <a href="/tambah-pengguna" class="btn btn-primary btn-sm mb-3">Tambah</a>
                    </div>
                    @if (session('success'))
                        <div class="col-lg-12">
            ...
            <div class="card-body px-0">
                ...
                <table id="user-list-table" class="table table-bordered table-hover" role="grid" data-toggle="data-table">
                    <thead>
                        <tr class="ligth">
                            <th>No</th>
                            <th>Foto</th>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="flex align-items-center list-user-action">
                                            <a href="/detail-pengguna/{{$item->id_user}}" class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Detail" data-original-title="Detail">
                                            ...
                                            <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit" data-original-title="Edit" href="/edit-pengguna/{{$item->id_user}}">
                                                <span class="btn-inner">
                                            ...
                                            <button type="button" class="btn btn-sm btn-icon btn-danger btn-delete" data-toggle="tooltip" data-placement="top" title="Hapus" data-original-title="Hapus" data-href="/hapus-pengguna/{{$item->id_user}}" data-content="Apakah Anda yakin akan hapus data pengguna bernama {{$item->fullname}} ?">
                                                <span class="btn-inner">
