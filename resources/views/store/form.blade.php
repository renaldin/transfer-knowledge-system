        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form === 'Tambah') /tambah-store @elseif($form === 'Edit') /edit-store/{{$detail->id_store}} @endif" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    @include('components.tombolForm', ['linkKembali' => '/daftar-store'])
                    </form>
                </div>
            </div>
        </div>
