        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    <form action="@if($form === 'Tambah') /tambah-data-stok @elseif($form === 'Edit') /edit-data-stok/{{$detail->id_stock}} @endif" method="POST" id="stockForm">
                    @csrf
                    <div class="row">
                        @if ($form === 'Edit')
                            <div class="form-group col-md-6">
                                <label class="form-label" for="id_product">Produk</label>
                                <input type="hidden" class="form-control" name="id_product" id="id_product" value="{{$detail->id_product}}">
                                <input type="text" class="form-control" name="product_name" id="product_name" value="{{$detail->product_name}}" readonly>
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    @include('components.tombolForm', ['linkKembali' => '/data-stok'])
                    </form>
                </div>
            </div>
        </div>
