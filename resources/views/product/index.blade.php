                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Tambah Stok" data-original-title="Tambah Stok" href="/stok-produk/{{$item->id_product}}">
