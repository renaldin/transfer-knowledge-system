            ...
            <div class="modal-body">
                <div class="row">
                    <form action="/edit-stok/{{$item->id_stock}}" method="POST">
                        ...
                        <div class="form-group col-md-12">
                            <label class="form-label" for="quantity">Kuantitas</label>
                            <input type="hidden" class="form-control" id="id_product" name="id_product" placeholder="Masukkan Kuantitas" value="{{$item->id_product}}">
...
<div class="modal fade" id="filter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Barang Masuk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <form action="/daftar-semua-stok" method="POST">
                        @csrf
                        <div class="form-group col-md-12">
