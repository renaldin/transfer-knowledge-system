    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/hapus-stok-opname/{{$item->id_stock_opname}}/{{$item->id_product}}" type="button" class="btn btn-danger">Hapus</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="filter" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Filter Stok Opname</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <form action="/daftar-semua-stok-opname" method="POST">
                        @csrf
                        <div class="form-group col-md-12">
