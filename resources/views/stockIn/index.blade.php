            ...
            <div class="card-body px-4">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{$stock->site_name}}" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label">Stok Awal</label>
                        <input type="text" class="form-control" value="{{$stock->early_stock}}" readonly>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label">Stok Terakhir</label>
                        <input type="text" class="form-control" value="{{$stock->last_stock}}" readonly>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($daftarStockIn as $item)
                            @if ($item->id_stock == $stock->id_stock)
                                <tr>
                                    <td>{{$no++}}</td>
                                    <td>{{$item->quantity}}</td>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="/tambah-stok-masuk" method="POST">
                        @csrf
                        <div class="form-group col-md-12">
                            <label class="form-label" for="quantity_opname">Kuantitas</label>
                            <input type="hidden" class="form-control" id="id_stock" name="id_stock" placeholder="Masukkan Stok" value="{{$stock->id_stock}}">
...
<div class="modal fade" id="edit{{$item->id_stock_in}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form action="/edit-stok-masuk/{{$item->id_stock_in}}" method="POST">
                        @csrf
                        <div class="form-group col-md-12">
                            <label class="form-label" for="quantity">Kuantitas</label>
                            <input type="hidden" class="form-control" id="id_stock" name="id_stock" placeholder="Masukkan Kuantitas" value="{{$stock->id_stock}}">
